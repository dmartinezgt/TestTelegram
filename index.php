...
$botToken = "477989100:AAFPoXbtGWIuvVgsxN5tfwSWrUtNweRixzY";
...
{
	$mensaje = "Si requieres soporte tecnico mandanos un mensaje a:%0Admartinez@digitalcomtech.com";
	enviarmensaje($chatId,$mensaje);
}
...
{
	$message = "Hola, soy <b>Una Prueba de GetHook Bot</b> y te puedo indicar tu /id%0ALo necesitas para que te pueda enviar alertas.%0ASi requieres asistencia solicita /soporte";
